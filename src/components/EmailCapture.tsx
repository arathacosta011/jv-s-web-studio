  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(ellipse at 50% 50%, hsl(43 100% 50% / 0.04) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="container relative">
        ...
        >
          <p className="text-primary font-body text-[11px] tracking-[0.3em] uppercase mb-4">
            Stay in the Loop
          </p>
          ...
          {submitted ? (
            <motion.div
              ...
              className="flex items-center justify-center gap-3 text-primary font-body"
            >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <Button variant="hero" size="default" type="submit">
                Join
          ...
          <p className="text-[11px] text-muted-foreground/50 font-body mt-5">
