...
const Footer = () => {
  return (
    <footer className="border-t border-border/20 bg-surface py-16 relative">
          ...
          <div className="md:text-right">
            ...
            <div className="flex md:justify-end gap-4">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-secondary/50 border border-border/30 flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/20 transition-all"
              >
