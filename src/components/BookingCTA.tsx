...
const ShopCTA = () => {
  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ backgroundImage: "radial-gradient(ellipse at 50% 40%, hsl(270 85% 65% / 0.1) 0%, transparent 60%)" }} />

      <div className="container relative">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 leading-[0.92]">
            READY TO<br /><span className="text-gradient-violet">LEVEL UP?</span>
          </h2>
