...
export const Scene5FinalHero: React.FC<{ isVertical: boolean }> = ({ isVertical }) => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Trophy reveal: scale from large to resting
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#050210", opacity: endFade }}>
      ...
      >
        <Img
          src={staticFile(isVertical ? "images/hero-clipper-vertical.jpg" : "images/final-hero.jpg")}
