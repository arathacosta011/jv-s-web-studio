      ...
      <div className="flex gap-2">
        ...
        {totalItems > 0 && (
          <Button variant="outline" size="lg" onClick={() => setIsOpen(true)} className="relative">
            ...
            <span className="absolute -top-1 -right-1 min-w-[18px] bg-primary text-primary-foreground text-[10px] font-bold rounded-full flex items-center justify-center px-1">{totalItems}</span>
          </Button>
        )}
      </div>
    </div>
